var VirtualJoystick	= function(opts)
{
	...
	this._baseEl.style.left		= (this._baseEl.width / 2 + 20) + "px";
	this._baseEl.style.top		= (this._baseEl.height / 2 - 20) + "px";
...
{
	x -= this._container.getBoundingClientRect().left;
	y -= this._container.getBoundingClientRect().top;
	this._pressed	= true; 
	this._baseX	= x;
	this._baseY	= y;
	this._stickX	= x;
